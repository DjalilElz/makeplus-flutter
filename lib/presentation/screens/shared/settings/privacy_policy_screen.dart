...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  static const _sections = [
    ...
    (
      ...
      body: 'MakePlus n\'utilise aucun outil d\'analyse ou de suivi '
    ...
    (
      ...
      body: 'MakePlus n\'est pas destiné aux enfants et ne collecte pas '
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(
            'MakePlus respecte votre vie privée. Cette page explique '
